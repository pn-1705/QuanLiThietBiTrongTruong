...
public class TrangChuJFrame extends javax.swing.JFrame {
    ...
    private void jButtonLuuTKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLuuTKActionPerformed
        ...
        staff.setTenNV(textFieldTenNV.getText());
        staff.setSoDienThoai(textFieldSDT.getText());
        staff.setNgaySinh(textFieldNgaySinh.getText());
        staff.setDiaChi(textFieldDiaChi.getText());

        staffService.updateNhanVien1(staff, taikhoan);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        new changePassJFrame(taikhoan).setVisible(true);
        this.dispose();
